...
lda <- read.csv("/Users/jisu/Documents//Glove/20190906_DMN_lda_allROI.csv")
svc <- read.csv("/Users/jisu/Documents//Glove/20190906_DMN_svc_allROI.csv")
...
png(paste0("/Users/jisu/Documents/Glove/20190906_DMN_SVC_corr_allROI.png"), width = 2500, height = 1000, res=220)
multiplot(p1, c1)
dev.off()
